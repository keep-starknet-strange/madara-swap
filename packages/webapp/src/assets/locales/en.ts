...
const enTranslate: TranslateState = {
  ...
  whitelist: {
    title: "Welcome on Madara Swap",
    introduction: "We’re excited to introduce our first vertical: a one-click revisited AMM",
    explanation:
      "This whitelist queue is here to consider and give credit to every feedback for the first days of born of Madara Swap.",
    ...
    once_registered: "Once registered you'll be able to access Madara Swap with the same address.",
  ...
  common: {
    ...
    testnet_warning_main:
      "<li>" +
      "  Madara Swap currently runs beta version on StarkNet " +
      "  <b>" +
      "    <u>testnet</u>," +
      "  </b>" +
    ...
    migrate_text:
      "Due to the recent Starknet update, you may need to migrate your assets to a new address. \r\n" +
      "You have the possibility to do it here for all your Madara Swap assets(We only transfer 1/2 your ETH)",
    recipient: "Recipient",
