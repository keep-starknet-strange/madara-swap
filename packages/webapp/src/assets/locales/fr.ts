...
const frTranslate: TranslateState = {
  ...
  whitelist: {
    title: "Bienvenu sur Madara Swap",
    ...
    once_registered: "Une fois enregistré, vous pourrez accédez à Madara Swap avec la même addresse.",
  ...
  common: {
    ...
    testnet_warning_main:
      "<li>" +
      "  Madara Swap est actuellement déployé en version beta sur le " +
      "  <b>" +
      "    <u>testnet</u>," +
      "  </b>" +
      "  de StarkNet, les transactions pourraient donc prendre jusqu'à " +
      "  <b>" +
      "    <u>10 minutes.</u>\n" +
      "  </b>" +
      "</li>",
    ...
    migrate_text:
      "Dû à la récente mise-à-jour de Starknet, il est possible que vous deviez migrer vos assets sur une nouvelle adresse. " +
      "Vous avez la possibilité de le faire ici pour l'ensemble de vos assets Madara Swap(Nous transférons uniquement 1/2 de vos ETH)",
    recipient: "Receveur",
